...
public class Haplotyper {
	...
	private int numReps, maxReps;
	private SimpleWeightedGraph<Sequence, DefaultWeightedEdge> togetherCounts;



	public Haplotyper(MultipleAlignment theAlignment, boolean theUseEpsilon, int theNumReps, int theMaxReps) throws Exception {
	...
	public void execute() throws Exception {
		...
		ArrayList<Sequence> universalSeqs = alignment.maskUnmaskedNoSNPSequences();
		//haplotypeBlocks = new ArrayList<HaplotypeBlock>();
	...
	private Haplotype createUniversalHaplotype(ArrayList<Sequence> universalSeqs) {
	...
	private HaplotypeBlock createUniversalBlock(Haplotype universalHaplotype) {
	 ...
	 * @return
	 */
	private HashMap<DisjointSetNode, Set<Sequence>> findTogethersByCountThreshold(ArrayList<Sequence> ccSeqList, int threshold) {
	 ...
	 * @return
	 */
	private HaplotypeBlock createNewHapBlockFromRootsToNodeLists(HashMap<DisjointSetNode, Set<Sequence>> rootsToNodeLists, String blockName) {
	 ...
	 * @return
	 */
	private void updateTogetherCounts(ArrayList<ArrayList<Sequence>> haplotypes) {
	...
	private ArrayList<ArrayList<Sequence>> bipartiteMatchAndGetHaplotypes(WeightedBipartiteGraph bpGraph, boolean useEpsilon) {
	 ...
	 * @return
	 */
	private ArrayList<Sequence> extractSequencesFromSequenceSet(Set<Sequence> nodeSet) {
	 ...
	 * @return
	 */
	private ArrayList<Sequence> extractSequencesFromGraphNodeSet(Set<GraphNode> nodeSet) {
		HashSet<Sequence> seqSet = new HashSet<Sequence>();
		ArrayList<Sequence> seqList = new ArrayList<Sequence>();
